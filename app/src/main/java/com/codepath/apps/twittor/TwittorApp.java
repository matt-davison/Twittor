 ...
 *
 */
public class TwittorApp extends Application {
    ...
    public static TwittorClient getRestClient(Context context) {
        return (TwittorClient) TwittorClient.getInstance(TwittorClient.class, context);
    }
